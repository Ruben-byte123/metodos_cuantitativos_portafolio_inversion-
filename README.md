...
download_adj_close(): Descarga datos históricos de precios ajustados
compute_log_returns(): Calcula rendimientos logarítmicos y métricas anualizadas
min_variance_weights(): Calcula pesos del portafolio de mínima varianza
portfolio_metrics(): Calcula retorno, volatilidad y ratio Sharpe
show_results(): Optimiza y visualiza la frontera eficiente
Activos incluidos
...
Uso
Ejecutar las celdas en orden para descargar datos
Calcular métricas y optimizar portafolios
Visualizar la frontera eficiente
Comparar resultados contra benchmark
Metodología
